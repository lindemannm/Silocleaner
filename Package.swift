...
let package = Package(
    ...
    targets: [
        .target(
            ...
            sources: ["ReleaseSafety.swift", "DirectProcessInvocation.swift", "DestructiveOperationSafety.swift", "UserProcessEnvironment.swift", "HelperLifecycleState.swift", "FinderInvocation.swift"]
        ),
        .target(
            name: "SilocleanerHelperSecurity",

            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                if isExpanded {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("Silocleaner requires permissions to search all system locations comprehensively.")
                            .font(.caption)
                            .foregroundStyle(ThemeColors.shared(for: colorScheme).secondaryText)
                            .fixedSize(horizontal: false, vertical: true)
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                if isExpanded {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("A new version of Silocleaner is available for download.")
                            .font(.caption)
                            .foregroundStyle(ThemeColors.shared(for: colorScheme).secondaryText)
                            .fixedSize(horizontal: false, vertical: true)
                    }
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                if isExpanded {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("Check out the latest additions to Silocleaner.")
                            .font(.caption)
                            .foregroundStyle(ThemeColors.shared(for: colorScheme).secondaryText)
                            .fixedSize(horizontal: false, vertical: true)
                    }

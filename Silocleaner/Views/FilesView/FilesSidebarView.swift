            ...
            Menu {
                ...
                if appState.appInfo.arch == .universal {
                    Button("Lipo Architectures") {
                        ...
                        let message = String(format: NSLocalizedString("Silocleaner will strip the %@ architecture from %@'s executable file to save space. Would you like to proceed?", comment: "Lipo alert message"), isOSArm() ? "intel" : "arm64", appState.appInfo.appName)

                ...
                HStack(alignment: .center) {
                    ...
                    if isNested(path: path) {
                        InfoButton(
                            text: String(
                                localized:
                                    "Application file is nested within subdirectories. To prevent deleting incorrect folders, Silocleaner will leave these alone. You may manually delete the remaining folders if required."
                            ))
                    }

...
class UndoHistoryManager: ObservableObject {
    ...
    private init() {
        ...
        let silocleanerDir = appSupport.appendingPathComponent("Silocleaner")

        // Create directory if needed
        try? FileManager.default.createDirectory(at: silocleanerDir, withIntermediateDirectories: true)

        historyFileURL = silocleanerDir.appendingPathComponent("UndoHistory.json")

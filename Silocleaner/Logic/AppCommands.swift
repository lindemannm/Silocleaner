    ...
    var body: some Commands {
        ...
        CommandGroup(replacing: .appInfo) {
            ...
            Button {
                showCustomAlert(
                    title: "Warning!",
                    message: "Silocleaner and all of its files will be cleanly removed, are you sure?",
                    okText: "Uninstall",
                    style: .warning,
                    onOk: {
                        uninstallSilocleaner(appState: appState, locations: locations)
                    }
                )
            } label: {
                Label("Uninstall Silocleaner", systemImage: "trash.fill")
            }
        ...
        CommandGroup(after: .help) {
            ...
            Button
            {
                NSWorkspace.shared.open(URL(string: "https://github.com/lindemannm/Silocleaner")!)
            } label: {
            ...
            Button
            {
                NSWorkspace.shared.open(URL(string: "https://github.com/lindemannm/Silocleaner/releases")!)
            } label: {
            ...
            Button
            {
                NSWorkspace.shared.open(URL(string: "https://github.com/lindemannm/Silocleaner/issues")!)
            } label: {
            ...
            Button
            {
                NSWorkspace.shared.open(URL(string: "https://github.com/lindemannm/Silocleaner/issues/new/choose")!)
            } label: {

...
func getMDLSMetadata(for paths: [String]) -> [String: [String: Any]]? {
    ...
    let queue = DispatchQueue(label: "com.silocleaner.metadata", qos: .userInitiated, attributes: .concurrent)
    let group = DispatchGroup()

    var allResults: [String: [String: Any]] = [:]
    let resultsQueue = DispatchQueue(label: "com.silocleaner.metadata.results")
